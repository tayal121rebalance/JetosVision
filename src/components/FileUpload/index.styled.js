...
export const WorksContainerOne = styled.div`
  box-sizing: border-box;
  display: flex;
  flex-direction: column;
...
export const WorkIconOne = styled.div`
  height: 6rem;
  width: 6rem;
...
export const WorkNumOne = styled.div`
...
export const WorksContainerTwo = styled.div`
  box-sizing: border-box;
  display: flex;
  flex-direction: column;
  justify-content: space-between;
...
export const WorkIconTwo = styled.div`
  height: 6rem;
  width: 6rem;
...
export const WorkNumTwo = styled.div`
...
export const WorksContainerThree = styled.div`
  box-sizing: border-box;
  display: flex;
  flex-direction: column;
  justify-content: space-between;
...
export const WorkIconThree = styled.div`
  height: 2rem;
  width: 2rem;
 ...
 .one {
  ...
  background: linear-gradient(180deg, rgba(255, 255, 255, 0.125) 0%, rgba(255, 255, 255, 0.5) 100%);
  opacity: 0.5;
 }

`;

export const WorkNumThree = styled.div`
...
export const WorksContainerFour = styled.div`
  box-sizing: border-box;
  display: flex;
  flex-direction: column;
  justify-content: space-between;
...
export const WorkIconFour = styled.div`
  height: 2rem;
  width: 2rem;
...
export const WorkNumFour = styled.div`
